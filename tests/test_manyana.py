...
def test_insertions():
    ...
    for perm in permutations(mylist):
        _test_insertions_single(*mylist)
...
def test_insertions_below():
    ...
    for perm in permutations(mylist):
        _test_insertions_below_single(*mylist)
...
def test_associativity():
    # Three branches from same ancestor with different generation counts
